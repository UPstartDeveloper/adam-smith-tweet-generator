...
consumer_secret = (
    os.environ.get('TWITTER_CONSUMER_SECRET').encode('utf-8'))
access_token = (
    os.environ.get('TWITTER_ACCESS_TOKEN').encode('utf-8'))
access_token_secret = (
    os.environ.get('TWITTER_ACCESS_TOKEN_SECRET').encode('utf-8'))
...
authenticated = tweepy.API(session)
